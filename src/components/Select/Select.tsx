...
export function Select(props: SelectProps & any) {
  ...
  const dark1 = 'hsl(240, 35%, 98%)';
  const dark2 = 'hsl(240, 35%, 95%)';
  const dark3 = 'hsl(240, 35%, 90%)';
  const dark4 = 'hsl(240, 35%, 85%)';
  const dark6 = 'hsl(240, 10%, 50%)';
  const dark8 = 'hsl(240, 10%, 30%)';
  const white = '#ffffff';
